...
//    	alert("I am an alert box!01");
        if (!this.$buttons) {
            return;
        }
        var self = this;
        this.$buttons.on('click', '.o_button_import_file_test', function () {
