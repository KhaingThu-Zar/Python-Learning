odoo.define('base_file_import.import', function (require) {
"use strict";
...
var DataImport = AbstractAction.extend(ControlPanelMixin, {
    ...
    renderButtons: function() {
        var self = this;
        this.$buttons = $(QWeb.render("FileImportView.buttons", this));
